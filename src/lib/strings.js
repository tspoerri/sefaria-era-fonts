...
export const STRINGS = {
  en: {
    ...
    alignmentCenter: "Side-by-side (HE left, EN right)",
    nikkud: "Nikkud",
    fontStyle: "Font style",
    fontStyleCasual: "Historical — casual",
    fontStyleFormal: "Historical — formal",
    fontStyleAccessible: "Accessible",
    tanachSection: "Tanach",
    otherSection: "Other sefarim",
    presetKlaf: "Klaf (scroll)",
    presetSefer: "Sefer (book)",
    presetSimple: "Simple",
    presetCustom: "Custom",
    taamim: "Taamim",
    punctuation: "Punctuation",
    verseLineBreaks: "Verse line breaks",
    chapterLineBreaks: "Chapter line breaks",
    chapterVerseNumbers: "Chapter and verse numbers",
    chapterHeadings: "Chapter headings",
    titleNikkud: "Source title nikkud",
    sourceTitleSection: "Source title",
    ...
    selectWordsHintTap: "Tap a word to start; tap another to select the range.",
    selectWordsHintTapPending: "Tap another word to finish the range.",
  ...
  he: {
    ...
    alignmentCenter: "זה לצד זה (עברית משמאל, אנגלית מימין)",
    nikkud: "ניקוד",
    fontStyle: "סגנון גופן",
    fontStyleCasual: "היסטורי — יומיומי",
    fontStyleFormal: "היסטורי — רשמי",
    fontStyleAccessible: "נגיש",
    tanachSection: "תנ״ך",
    otherSection: "ספרים אחרים",
    presetKlaf: "קלף (מגילה)",
    presetSefer: "ספר",
    presetSimple: "פשוט",
    presetCustom: "מותאם אישית",
    taamim: "טעמים",
    punctuation: "פיסוק",
    verseLineBreaks: "מעברי שורה לפסוק",
    chapterLineBreaks: "מעברי שורה לפרק",
    chapterVerseNumbers: "מספרי פרק ופסוק",
    chapterHeadings: "כותרות פרקים",
    titleNikkud: "ניקוד כותרת המקור",
    sourceTitleSection: "כותרת המקור",
    ...
    selectWordsHintTap: "הקש על מילה כדי להתחיל; הקש על מילה נוספת לבחירת הטווח.",
    selectWordsHintTapPending: "הקש על מילה נוספת כדי לסיים את הטווח.",
